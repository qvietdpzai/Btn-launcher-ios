...
- (BOOL)isVersionInstalled:(NSString *)versionId {
    NSString *localPath = [NSString stringWithFormat:@"%s/versions/%@", getenv("BTN_GAME_DIR"), versionId];
    BOOL isDirectory;
...
- (void)fetchLocalVersionList {
    ...
    NSString *versionPath = [NSString stringWithFormat:@"%s/versions/", getenv("BTN_GAME_DIR")];

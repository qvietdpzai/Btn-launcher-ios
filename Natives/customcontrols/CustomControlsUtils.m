...
void generateAndSaveDefaultControl() {
    NSString *defaultPath = [NSString stringWithFormat:@"%s/controlmap/default.json", getenv("BTN_HOME")];
...
void generateAndSaveDefaultControlForGamepad() {
    NSString *gamepadPath = [NSString stringWithFormat:@"%s/controlmap/gamepads/default.json", getenv("BTN_HOME")];

...
- (void)actionShareLatestlog {
    NSString *latestlogPath = [NSString stringWithFormat:@"file://%s/latestlog.txt", getenv("BTN_HOME")];
...
+ (void)handleExitCode:(int)code {
    ...
    dispatch_async(dispatch_get_main_queue(), ^(void){
        ...
        NSString *latestlogPath = [NSString stringWithFormat:@"%s/latestlog.txt", getenv("BTN_HOME")];

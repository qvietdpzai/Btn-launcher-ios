...
import com.btnlauncher.uikit.*;
import com.btnlauncher.utils.*;
import com.btnlauncher.value.*;

public class BtnLauncher {
    ...
    public static void launchMinecraft(String[] args) throws Throwable {
        ...
        if (System.getProperty("btn.internal.keepForgeSplash") == null) {

...
public class GLFW
{
    ...
    static {
        try {
            System.load(System.getenv("BUNDLE_PATH") + "/BtnLauncher");
    ...
    private static final SharedLibrary GLFW = new MacOSXLibraryDL("BtnLauncher", DynamicLinkLoader.RTLD_DEFAULT);
    ...
    public static final class Functions {
        ...
        Init = apiGetFunctionAddress(GLFW, "btnInit"),
        CreateContext = apiGetFunctionAddress(GLFW, "btnCreateContext"),
        GetCurrentContext = apiGetFunctionAddress(GLFW, "btnGetCurrentContext"),
        //DetachOnCurrentThread = apiGetFunctionAddress(GLFW, "btnDetachOnCurrentThread"),
        MakeContextCurrent = apiGetFunctionAddress(GLFW, "btnMakeCurrent"),
        Terminate = apiGetFunctionAddress(GLFW, "btnTerminate"),
        SetWindowHint = apiGetFunctionAddress(GLFW, "btnSetWindowHint"),
        SwapBuffers = apiGetFunctionAddress(GLFW, "btnSwapBuffers"),
        SwapInterval = apiGetFunctionAddress(GLFW, "btnSwapInterval"),
        PumpEvents = apiGetFunctionAddress(GLFW, "btnPumpEvents"),
        RewindEvents = apiGetFunctionAddress(GLFW, "btnRewindEvents");
    }
        ...
        if (mode == GLFW_CURSOR) {
            switch (value) {
                case GLFW_CURSOR_DISABLED:
                    com.btnlauncher.uikit.UIKit.updateMCGuiScale();
